...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getAgentBridgeConfig: (projectId) => ipcRenderer.invoke('app:getAgentBridgeConfig', { projectId }),
  listAgentRuntimes: () => ipcRenderer.invoke('app:listAgentRuntimes'),
  startAgentRuntime: (payload) => ipcRenderer.invoke('app:startAgentRuntime', payload),
  stopAgentRuntime: () => ipcRenderer.invoke('app:stopAgentRuntime'),
  onAgentRuntimeOutput: (cb) => ipcRenderer.on('app:agent-runtime-output', (_e, data) => cb && cb(data)),
  onAgentRuntimeClosed: (cb) => ipcRenderer.on('app:agent-runtime-closed', (_e, data) => cb && cb(data)),
